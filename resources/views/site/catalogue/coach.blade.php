                    ...
                    <div class="tg-textshortcode">
                        <div class="tg-sectionhead tg-sectionheadvtwo">
                            <div class="tg-sectiontitle reveal-3">
                                <h2  style="color: black; font-family: 'lora'">
                                    Formulaire de coaching sur mesures
                                </h2>
                            </div>
                        </div>
                        <div class="tg-description reveal-4">
                            <p style="color: black !important; font-size: 20px">
                                ...
                                formules de Coaching. Elles s’adressent à tous, particuliers, entrepreneurs, grandes entreprises, propriétaires, et sont adaptées à vos besoins
                            </p>
                            <p style="color: black !important; font-size: 20px">
                                Nous vous accompagnons dans un processus de formalisation de votre entreprise tout en assurant la qualité et la pertinence de vos idées.
                            </p>
                            <div style="padding-left: 30%; font-size: 19px; color: black">
                                <ul>
                                    <li><i style="color: #084f68!important" class="fa fa-check-circle"></i>  Accompagnement ouverture et /ou formalisation</li>
                                    <li><i style="color: #084f68!important" class="fa fa-check-circle"></i>  Assistance pour la maitrise des ouvrages</li>
                                    <li><i style="color: #084f68!important" class="fa fa-check-circle"></i>  Assistance au pilotage de programme</li>
                                    <li><i style="color: #084f68!important" class="fa fa-check-circle"></i>  Accompagnement des équipes de projet et gouvernance de projet</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div class="container">
            <div  class="row reveal-2"  style="padding-top: 50px">
                <div class="tg-themefeatures tg-themefeaturesvthree">
                    <div class="tg-themefeature" style="padding-top: 50px">
                        <span  class="tg-themefeatureicon"><i class="icon-smiling-face"></i></span>
                        <h3 style="color: #373737; font-family: 'Manjari Bold'">LIBEREZ VOTRE PLEIN POTENTIEL</h3>
                        <div class="tg-description">
                            <p style="color: #373737">
                                Nous sommes les pires pour reconnaître nos propres faiblesses. Vous avez besoin d’un coach pour voir ce qui vous bloquait jusqu’à présent et libérer votre plein potentiel.
                            </p>
                        </div>
                    </div>
                    <div class="tg-themefeature"  style="padding-top: 50px">
